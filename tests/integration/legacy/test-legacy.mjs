...
const { getFirestore, connectFirestoreEmulator, doc, getDoc } = expoRequire('firebase/firestore');
import { inspectRoom, readOptions, readRoomSnapshot } from '../../../legacy/expo/scripts/legacy-preflight.mjs';
