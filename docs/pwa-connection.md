...
5. 새 Vercel 프로젝트의 Production 공개 환경과 고정 주소는 준비됐지만 실제 production deployment는 아직 없다. 프로젝트 루트, Production Branch=`main`, Ignored Build Step=`Only build production`을 유지하고 main 반영 전 다시 대조한다.
