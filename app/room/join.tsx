...
export default function JoinRoom() {
  ...
  const showCodeError = code.length > 0 && !!codeError;
        ...
        <View style={styles.body}>
          <View>
            ...
            <TextInput
              ...
              style={[styles.input, styles.codeInput, showCodeError && styles.inputError]}
              maxLength={6}
              ...
              accessibilityHint={showCodeError ? codeError : undefined}
            />
            <Text style={[typography.tab, showCodeError ? styles.errorText : styles.metaText]}>
              {showCodeError ? codeError : `${code.length}/6`}
            </Text>
          </View>
          ...
          >
            {submitting ? (
              ...
              <Text style={[typography.bodyMedium, canSubmit && styles.onPrimary]}>입장하기</Text>
            )}
          </PressableScale>
        </View>
      </KeyboardAvoidingView>
